...
export async function removeFromCart(cartId: string, lineIds: string[]): Promise<lCart> {
...
export async function getProduct(handle: string): Promise<imgProduct | undefined> {
...
export async function getProductRecommendations(productId: string): Promise<imgProduct[]> {
