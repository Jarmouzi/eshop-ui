...
export default async function Navbar() {
  ...
  return (
    <nav className="relative items-center justify-between p-4 lg:px-6 z-50">
      ...
      <div className="flex w-full items-center py-1">
        <div className="flex w-full md:w-1/3">
          ...
          <LogoSquare />
          <div className="ml-2 flex-none px-2 text-2xl font-extrabold uppercase md:hidden lg:block">
            {SITE_NAME}
          </div>
          </Link>
        </div>
      ...
      <div className="container mx-auto flex justify-between">
        <ul className="flex">
               ...
               {menu.map((item: Menu) => {
                return (
                  item.Children.length ? (
                    <li className="text-neutral-500 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">
          ...
          {/*Toggleable Link*/}
          <li className="toggleable hover:bg-teal-100 hover:text-teal-950">
            <input type="checkbox" defaultValue="selected" id="toggle-one" className="toggle-input" />
            <label htmlFor="toggle-one" className="block cursor-pointer py-6 px-4 lg:p-4 text-sm lg:text-base font-bold">Click</label>
            <div role="toggle" className="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-teal-100">
          ...
          */}
          {/*Hoverable Link*/}
          <li className="hoverable hover:bg-teal-100  hover:text-teal-950">
            <a href="#" className="relative block py-6 px-4 lg:p-4 text-sm lg:text-base font-bold hover:bg-teal-100  hover:text-teal-950">Hover</a>
            <div className="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-teal-100">
              <div className="container mx-auto w-full flex flex-wrap justify-between mx-2">
          ...
          <li class="hoverable hover:bg-teal-100 hover:text-white"><a href="#" class="relative block">x</a><div class="mega-menu">
          Add your mega menu content
          </div></li>
